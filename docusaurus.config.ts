...
const config: Config = {
  title: 'Racines — Documentation',
  tagline: 'La documentation de la plateforme Racines',
  ...
  organizationName: 'mattrbdr',
  projectName: 'racines-documentation',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/mattrbdr/racines-documentation/tree/main/',
        },
        blog: {
